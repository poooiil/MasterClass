# Modified from: https://github.com/wangsen1312/joints2smpl
# Original Author : wangsen1312
...
parser.add_argument('--num_joints', type=int, default=22,
                    help='joint number')
parser.add_argument('--joint_category', type=str, de
fault="AMASS",
...
parser.add_argument('--files', type=str, default="0_p0_p1.npy",
                    help='files use')
